...
public class Login extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        User usuario = new User(emailInput.getText(), senhaInput.getText());
        usuario = userDao.selectUserPorEmailSenha(usuario);
        us = usuario.getId();
        if (userDao.existeUser(usuario)) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormPeso.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
